...
Perangkat lunak yang dibangun akan memiliki 2 proses, yaitu membagi \textit{password} atau \textit{secret} dan mengembalikan \textit{password} atau \textit{secret}. Diagram aktivitas di bawah ini menunjukkan proses membagi \textit{password} atau \textit{secret}.

%diagram
\begin{figure}[h]
	\includegraphics[scale=0.5]{Gambar/sharing-secret}
	\label{fig:sharing-secret}
	\caption{Diagram aktivitas untuk membagi \textit{password}}
\end{figure}