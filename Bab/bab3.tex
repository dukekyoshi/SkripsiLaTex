...
Selanjutnya adalah proses untuk mengembalikan \textit{password}. Diagram aktivitas di bawah ini menunjukkan proses mengembalikan \textit{password}

%diagram
\begin{figure}[H]
	\centerline{\includegraphics[scale=0.4]{Gambar/reconstruct-secret}}
	\label{fig:reconstruct-secret}
	\caption{Diagram aktivitas untuk mengembalikan \textit{password}}
\end{figure}
